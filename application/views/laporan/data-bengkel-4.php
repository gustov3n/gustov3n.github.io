  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<a onclick="return confirm('Anda yaking ingin menghapus data ini?')" href="<?=base_url('laporan/hapusfoto/'.$mfoto['id_foto'].'/'.$noreg);?>" class="btn btn-sm btn-danger" href=""><i class="fas fa-fw fa-trash-alt text-white-50"></i> Hapus</a>
      </div>
    </div>
  </div>
</div>
