      ...
      <tbody>
        <?php $no=0; foreach ($bengkel as $row): $no++; ?>
          <tr>
            ...
            <td data-toggle="tooltip" data-placement="top" title="Kelola" class="text-center align-middle"><a href="<?=base_url('data/kelolabengkel/1/'.$row['noreg']);?>"><i class="fas fa-fw fa-folder-open"></i></a></td>
            <td class="text-center align-middle"><a data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="<?= base_url('data/hapusbengkel/'.$row['noreg'].'/bengkel');?>"><i class="fas fa-fw fa-trash-alt text-primary"></i></a></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
