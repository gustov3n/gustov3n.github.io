							...
							<tr>
								...
								<td>
									...
									<?php if (!empty($ceklayanan)): ?>
										<a href="<?=base_url('data/hapuslayananbengkel/'.$noreg.'/'.$row['id_ply']);;?>"><i class="fas fa-fw fa-toggle-on text-teal"></i></a>
									<?php else: ?>
										<a href="<?=base_url('data/tambahlayananbengkel/'.$noreg.'/'.$row['id_ply']);;?>"><i class="fas fa-fw fa-toggle-off text-dark"></i></a>
									<?php endif ?>
								</td>
							</tr>
						<?php endforeach ?>
