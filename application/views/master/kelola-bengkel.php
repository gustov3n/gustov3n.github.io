...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?=base_url('master/ubahdatabengkel/'.$noreg);?>" method="post">
				  ...
				  <div class="form-group">
				  	<div class="row">
				  		...
				  		<div class="col-2">
				  			<a class="btn btn-block btn-sm btn-dark" href="<?=base_url('master/bengkel');?>"><i class="fas fa-fw fa-times text-white-50"></i> Batal</a>
				  		</div>
				  	</div>
				  </div>
				</form>
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="col">
						<form method="post" enctype="multipart/form-data" action="<?=base_url('master/upload/'.$noreg);?>">
