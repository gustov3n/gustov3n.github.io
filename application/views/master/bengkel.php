<div class="row">
  <div class="col-sm-9 mb-sm-0 mb-sm-3">
    <a class="btn btn-sm btn-primary" href="<?=base_url('master/tambahbengkel/'.$noreg);?>"><i class="fas fa-fw fa-plus text-white-50"></i> Tambah Bengkel</a>
    <!-- <a class="btn btn-sm btn-primary" href="<?=base_url('master/kelolabengkel/1/'.$noreg);?>"><i class="fas fa-fw fa-plus text-white-50"></i> Tambah Bengkel</a> -->
  </div>
  <div class="col-sm-3 mb-sm-0 mb-sm-3 d-flex justify-content-end">
    <form action="" method="post">
      <div class="form-row">
        ...
        <div class="col-sm-2 mb-sm-0 mb-sm-3">
          <a href="<?= base_url('master/reset/master/bengkel');?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Reset Pencarian"><i class="fas fa-fw fa-sync text-white-50"></i></a>
        </div>
      </div>
    </form>
  </div>
    ...
    <table class="table table-sm table-responsive-sm table-hover table-striped bg-white table-bordered">
      ...
      <!-- <thead style="background-color:#F1BC31;"> -->
        <tr>
          ...
          <th class="text-center align-middle">BENGKEL</th>
      ...
      <tbody>
        <?php $no=0; foreach ($bengkel as $row): $no++; ?>
          <tr>
            ...
            <td class="text-center align-middle"><?='['.$row['kategori_kode'].'] '.$row['nama_kategori'];?></td>
            <td class="text-left">
              <i class="fas fa-fw fa-check text-secondary"></i><a href=""><i class="fas fa-fw fa-phone"></i></a><br>
            ...
            <td class="text-center align-middle"><?=$row['alamat_bengkel'].', '.$row['nama_kel'].', '.$row['nama_kec'];?></td>
            <td class="text-left">
              <?php 
                $this->db->select('*');
            ...
            <td data-toggle="tooltip" data-placement="top" title="Kelola" class="text-center align-middle"><a href="<?=base_url('master/kelolabengkel/'.$row['noreg']);?>"><i class="fas fa-fw fa-folder-open"></i></a></td>
            <td data-toggle="tooltip" data-placement="top" title="Layanan" class="text-center align-middle"><a href="<?=base_url('master/layanan/'.$row['noreg']);?>"><i class="fas fa-fw fa-wrench"></i></a></td>
            <td class="text-center align-middle"><a data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="<?= base_url('master/hapusbengkel/'.$row['noreg'].'/bengkel');?>"><i class="fas fa-fw fa-trash-alt text-primary"></i></a></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form method="post" action="<?=base_url('master/tambahbengkel');?>">
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form method="post" action="<?=base_url('master/ubahbengkel/'.$row['noreg'].'/bengkel');?>">
      <div class="form-group row">
