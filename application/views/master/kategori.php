<div class="row">
  <div class="col-sm-9 mb-sm-0 mb-sm-3">
    <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalAdd"><i class="fas fa-fw fa-plus text-white-50"></i> Tambah Kategori</a>
  </div>
...
<div class="modal-content">
  <div style="background-color:#B22222;" class="modal-header text-light">
    <h5 class="modal-title" id="staticBackdropLabel">Form Tambah Pegawai</h5>
  ...
  <div class="modal-body">
    <form method="post" action="<?=base_url('developer/tambahfunc');?>">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select type="text" name="opd" class="form-control form-control-sm" required>
            <option>--</option>
            <?php foreach ($opd as $r_opd): ?>
              <option value="<?=$r_opd['kode_opd'];?>"><?=$r_opd['nama_opd'];?></option>
            <?php endforeach ?>
          </select>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select type="text" name="mesin" class="form-control form-control-sm" required>
            <option>--</option>
            <?php foreach ($mesin as $r_mesin): ?>
              <option value="<?=$r_mesin['kode_mesin'];?>"><?=$r_mesin['nama_mesin'];?></option>
            <?php endforeach ?>
          </select>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input required type="text" name="nip" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input required type="text" name="pin" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">TGL LAHIR</label>
        <div class="col-sm-10">
          <input required type="text" name="tgllhr" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">JABATAN</label>
        <div class="col-sm-10">
          <input required type="text" name="jabatan" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">PANGKAT</label>
        <div class="col-sm-10">
          <input required type="text" name="pangkat" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">GOLONGAN</label>
        <div class="col-sm-10">
          <input required type="text" name="golongan" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">PENSIUN</label>
        <div class="col-sm-10">
          <input required type="text" name="pensiun" class="form-control form-control-sm">
        </div>
      </div>
      <div class="form-group row">
