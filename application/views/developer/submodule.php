<div class="row">
  <div class="col-sm-9 mb-sm-0 mb-sm-3">
    <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalAdd"><i class="fas fa-fw fa-plus text-white-50"></i> Tambah Submodule</a>
  </div>
  <div class="col-sm-3 mb-sm-0 mb-sm-3 d-flex justify-content-end">
    <form action="" method="post">
      <div class="form-row">
        ...
        <div class="col-sm-2 mb-sm-0 mb-sm-3">
          <a href="<?= base_url('developer/reset/developer/submodule');?>" class="btn btn-sm btn-dark" data-toggle="tooltip" data-placement="top" title="Reset Pencarian"><i class="fas fa-fw fa-sync text-white-50"></i></a>
        </div>
      </div>
    </form>
  </div>
    ...
    <table class="table table-sm table-responsive-sm table-hover table-striped bg-white table-bordered">
      ...
      <!-- <thead style="background-color:#F1BC31;"> -->
        <tr>
          ...
          <th class="text-center align-middle">Submodule</th>
          <th class="text-center align-middle">Url Submodule</th>
      ...
      <tbody>
        <?php $no=0; foreach ($submodule as $row): $no++; ?>
          <tr>
            ...
            <td class="text-center align-middle"><a data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="<?= base_url('developer/hapussubmodule/'.$row['id_submodule'].'/submodule');?>"><i class="fas fa-fw fa-trash-alt text-primary"></i></a></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
...
<div class="modal-content">
  <div style="background-color:#B22222;" class="modal-header text-light">
    <h5 class="modal-title" id="staticBackdropLabel">Form Tambah Submodule</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
  <div class="modal-body">
    <form method="post" action="<?=base_url('developer/tambahsubmodule');?>">
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form method="post" action="<?=base_url('developer/ubahsubmodule/'.$row['id_submodule'].'/submodule');?>">
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Module</label>
        <div class="col-sm-10">
          <select required type="text" name="module" class="form-control form-control-sm">
